        ...
        <AuthProvider>
          <ThemeProvider>
            <Routes>
              ...
              <Route
                path="/profile/:userId"
                element={<AnonymousPage component={Profile} layout={Layout} />}
              ></Route>
              <Route
                path="/collection/:id"
                element={
              ...
              <Route
                path="/item/:id"
                element={<AnonymousPage component={ItemPage} layout={Layout} />}
              ></Route>
              <Route
                path="/search/"
              ...
              <Route
                path="/admin"
                element={<PrivatePage component={AdminPage} layout={Layout} />}
              ></Route>
              <Route
                path="*"
                element={<AnonymousPage layout={Layout} component={NotFound} />}
              ></Route>
            </Routes>
          </ThemeProvider>
        </AuthProvider>
