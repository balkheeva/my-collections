import {Stack, Container, Button, Form, Alert} from "react-bootstrap";
    ...
    return <CustomContainer>
        <Container className="p-5 mb-4 mt-4 rounded-3 bg-white">
            <Form>
                ...
                <p className="text-center">Already have an account? Sign in <Link to="/login">here</Link></p>
                <Stack className="col-md-3 mx-auto justify-content-center" direction="horizontal" gap={{xs: 5}}>
                    <Button className="justify-content-md-center" disabled={isLoading}
